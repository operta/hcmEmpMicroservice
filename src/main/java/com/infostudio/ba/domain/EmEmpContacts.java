...
public class EmEmpContacts implements Serializable {
    ...
    public EmEmpContacts createdBy(String createdBy) {
    ...
    public EmEmpContacts createdAt(Instant createdAt) {
    ...
    public EmEmpContacts updatedBy(String updatedBy) {
    ...
    public EmEmpContacts updatedAt(Instant updatedAt) {
