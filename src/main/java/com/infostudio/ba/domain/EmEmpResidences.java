...
public class EmEmpResidences implements Serializable {
    ...
    public EmEmpResidences createdBy(String createdBy) {
    ...
    public EmEmpResidences createdAt(Instant createdAt) {
    ...
    public EmEmpResidences updatedBy(String updatedBy) {
    ...
    public EmEmpResidences updatedAt(Instant updatedAt) {
