...
public class EmEmpMetaDataResource {
    ...
    public EmEmpMetaDataResource(EmEmpMetaDataRepository emEmpMetaDataRepository,
                EmEmpMetaDataMapper emEmpMetaDataMapper,
        ...
        @Timed
        public ResponseEntity<EmEmpMetaDataDTO> createEmEmpMetaData (@RequestBody EmEmpMetaDataDTO emEmpMetaDataDTO) throws
        URISyntaxException {
        ...
        public ResponseEntity<EmEmpMetaDataHelperDTO> createMetadataForEmployee (@RequestBody EmEmpMetaDataHelperDTO
        emEmpMetaDataHelper){
        ...
        @Timed
        public ResponseEntity<EmEmpMetaDataDTO> updateEmEmpMetaData (@RequestBody EmEmpMetaDataDTO emEmpMetaDataDTO) throws
        URISyntaxException {
        ...
        public ResponseEntity<Void> deleteEmEmpMetaData (@PathVariable Long id){
            ...
            EmEmpMetaData metaData = emEmpMetaDataRepository.findOne(id);
            emEmpMetaDataRepository.delete(id);
            applicationEventPublisher.publishEvent(
                    AuditUtil.createAuditEvent(
                            metaData.getIdEmployee().getId().toString(),
                            ENTITY_NAME,
