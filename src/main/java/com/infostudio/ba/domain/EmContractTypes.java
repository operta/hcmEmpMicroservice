...
public class EmContractTypes implements Serializable {
    ...
    public EmContractTypes createdBy(String createdBy) {
    ...
    public EmContractTypes createdAt(Instant createdAt) {
    ...
    public EmContractTypes updatedBy(String updatedBy) {
    ...
    public EmContractTypes updatedAt(Instant updatedAt) {
